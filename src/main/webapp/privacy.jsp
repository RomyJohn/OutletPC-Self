...
<html>
    <head>
        ...
        <title>Privacy Policy - Outletpc</title>
        <style>
            section p {
                font-size: 15px;
            }
    ...
    <body class="bg-light">
        ...
        <section>
            <div class="container bg-white" id="privacy">
