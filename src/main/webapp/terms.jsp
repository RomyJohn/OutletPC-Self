...
<html>
    <head>
        ...
        <title>Buy Terms - Outletpc</title>
        <style>
            section p {
                font-size: 15px;
            }
            ...
            <div class="container bg-white">
                <div class="row justify-content-center">
                    <div class="col-md-10 my-5">
                        <h5>Terms of Use</h5>
                        <br>
                        <p>Your use of the Platform and services and tools are governed by the following terms and conditions <span>("Terms of Use")</span> as applicable to the Platform including the applicable policies which are incorporated herein by way of reference. If You transact on the Platform, You shall be subject to the policies that are applicable to the Platform for such transaction. By mere use of the Platform, You shall be contracting with Outletpc Internet Private Limited and these terms and conditions including the policies constitute Your binding obligations, with outletpc.</p>
                        <p>For the purpose of these Terms of Use, wherever the context so requires <span>"You"</span> or <span>"User"</span> shall mean any natural or legal person who has agreed to become a buyer on the Platform by providing Registration Data while registering on the Platform as Registered User using the computer systems. Outletpc allows the User to surf the Platform or making purchases without registering on the Platform. The term <span>"We"</span>, <span>"Us"</span>, <span>"Our"</span> shall mean Outletpc Internet Private Limited.</p>
                        ...
                        <p><span>ACCESSING, BROWSING OR OTHERWISE USING THE SITE INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING</span>. By impliedly or expressly accepting these Terms of Use, You also accept and agree to be bound by Outletpc Policies ((including but not limited to Privacy Policy available at Privacy) as amended from time to time.</p>
                        ...
                        <p>As a minor if you wish to transact on the Platform, such transaction on the Platform may be made by your legal guardian or parents. Outletpc reserves the right to terminate your membership and / or refuse to provide you with access to the Platform if it is brought to Outletpc's notice or if it is discovered that You are under the age of 18 years and transacting on the Platform.</p>
                        ...
                        <p>You agree that Outletpc shall not be liable or responsible for the activities or consequences of use or misuse of any information that occurs under your Account in cases, including, where You have failed to update Your revised mobile phone number and/or e-mail address on the Website Platform.</p>
                        ...
                        <p>The Platform is a platform that Users utilize to meet and interact with one another for their transactions. Outletpc is not and cannot be a party to or control in any manner any transaction between the Platform's Users.</p>
                    </div>
                </div>
            </div>
        </section>
